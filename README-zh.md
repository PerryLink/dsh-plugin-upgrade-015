...
| 面 | 状态 |
|---|---|
| 宿主 | DeepSeek Harness `0.1.5-rc.1`（tag `dsh-v0.1.7-alpha.1` = `183f08e9c6dd`；leg A→B 交接点 `dsh-v0.1.7-alpha.1` = `5dda764ed3aa`；走廊起点 `0.1.3-alpha.1`）。peer 区间 `@deepseek-ai/dsh-skill >=0.1.2-rc.1 <0.2.0 \|\| >=0.1.5-alpha.1 <0.2.0`、`@deepseek-ai/cordis ^4.0.2`、`@deepseek-ai/schemastery ^3.18.2`。 |
| Node | `^22.19.0 \|\| >=24.0.0` |
